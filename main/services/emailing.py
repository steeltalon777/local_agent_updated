...
def send_invoice_email(operation) -> None:
    ...
    # Новое имя настройки: OFFICE_EMAIL. Старое (ACCOUNTING_EMAIL) оставляем как fallback.
    accounting_email = getattr(settings, 'OFFICE_EMAIL', None) or getattr(settings, 'ACCOUNTING_EMAIL', None)
